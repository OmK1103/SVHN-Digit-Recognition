...
class SVHN(object):
    ...
    def load_model(**params):
        ...
        svhn.sess = tf.Session()
        print 'modi'
        svhn.newsaver = tf.train.import_meta_graph('modelz.ckpt.meta')
        print 'OMK'
        #svhn.sess = tf.InteractiveSession()
            #print 'OMK'
        svhn.newsaver.restore(svhn.sess, tf.train.latest_checkpoint('./'))

            #svhn.saver.restore(svhn.sess, "./model.ckpt")
        print 'OMK'
        print 'model loaded successfully'
            #print svhn.sess.run(tf.global_variables())
